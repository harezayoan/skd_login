            ...
            <div class="col-sm-6">
                <div class="card text-center">     
                    <div class="card-header">
                        <h3>Dekripsi Caesar Cipher</h3>
                    </div>           

                        <form action="" method="POST">
                            <div class="mb-3">
                                <label>Isi Teks</label>
                                <input  type="text" name="kata" <?php if(isset($_POST['proses'])){echo "value='".$_POST['kata']."'";} ?> class="form-control" placeholder="Masukan Cipher Text" required>            
                            </div>
                            <div class="mb-3">
                                <label>Isi Key</label>
                            ...
                            <div class="mt-3">
                                <input type="submit" class="btn btn-primary" name="proses" value="Dekripsi" >
                                <input type="reset"  class="btn btn-danger" name="reset" value="Reset" > <hr>
                                <a href="index.php" class="">Ekripsi</a>
                            </div>
                        </form>
